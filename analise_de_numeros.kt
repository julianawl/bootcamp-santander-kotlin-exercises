...
//pares, quantos valores informados são ímpares, quantos valores informados são positivos e 
...
fun main(args: Array<String>) {
  ...
  for (i in inteiros) { if (  i % 2 == 0  ) { pares.add(i) } else { impares.add(i) } }
  for (i in inteiros) { if (  i > 0  ) { positivos.add(i) } else if (  i < 0  ) { negativos.add(i) } }
