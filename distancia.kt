//Duas motos (X e Y) partem em uma mesma direção. A moto X sai com velocidade constante de 60 
//Km/h e a moto Y sai com velocidade constante de 90 Km/h.
...
fun main(args: Array<String>) {
    ...
    val dist = input.nextInt()
    val minutos = (60.times(dist)).div(30)
